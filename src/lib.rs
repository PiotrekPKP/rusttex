//! # RustTeX
//! 
//! RustTeX is a Rust library for programmatically generating LaTeX documents. 
//! It provides a builder-style API to create LaTeX content with ease, allowing 
//! you to focus on the structure and content of your document without worrying 
//! about syntax errors.
//! 
//! ## Features
//! 
